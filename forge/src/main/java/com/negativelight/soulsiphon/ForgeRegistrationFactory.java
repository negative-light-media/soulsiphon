...
public class ForgeRegistrationFactory implements RegistrationProvider.Factory {
    ...
    public <T> RegistrationProvider<T> create(ResourceKey<? extends Registry<T>> resourceKey, String modId) {
        Constants.LOG.info("Creating registry provider for " + modId + " resource key " + resourceKey.toString());
    ...
    private static class Provider<T> implements RegistrationProvider<T> {
        ...
        public <I extends T> RegistryObject<I> register(String name, Supplier<? extends I> supplier) {
            ...
            try {
                ...
                Constants.LOG.error("There was an error getting the Registry object");
            }
            return ro;
        }
